...
public:
     ...
     *          already verified the headers connect, and has checked that each header satisfies
     *          the proof-of-work target included in the header (but not necessarily verified that
     *          the proof-of-work target is correct and passes consensus rules).
