...
public:
    ...
    {
        const CScript eqver = CScript(OP_EQUALVERIFY);
        ...
        auto upfn = [&ctx, eqver](bool verify, const Node& node, Span<CScript> subs) -> CScript {
            switch (node.nodetype) {
                ...
                case NodeType::SHA256: return BuildScript(OP_SIZE, 32, eqver, OP_SHA256, node.data, verify ? OP_EQUALVERIFY : OP_EQUAL);
                ...
                case NodeType::WRAP_C: return BuildScript(subs[0], verify ? OP_CHECKSIGVERIFY : OP_CHECKSIG);
                ...
                case NodeType::WRAP_N: return BuildScript(subs[0], OP_0NOTEQUAL);
...
public:
    ...
    bool IsSane() const { return CheckTimeLocksMix() && CheckOpsLimit() && CheckStackSize() && IsValid(); }
