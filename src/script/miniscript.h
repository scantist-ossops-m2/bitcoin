...
#  define MINISCRIPT_CONSTEVAL consteval
#else
#  define MINISCRIPT_CONSTEVAL constexpr
#endif
...
public:
    ...
    static MINISCRIPT_CONSTEVAL Type Make(uint32_t flags) noexcept { return Type(flags); }
...
inline MINISCRIPT_CONSTEVAL Type operator"" _mst(const char* c, size_t l) {
