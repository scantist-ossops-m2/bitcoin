 ...
 *
 * The implied diagram for each starts at (0, 0), then contains for each chunk the fee and size up
 * to that chunk, and ends with an infinitely long horizontal line.
 */
