...
CandidateSetAnalysis<S> FindBestCandidateSetFancy(const Cluster<S>& cluster, const AncestorSets<S>& anc, const DescendantSets<S>& desc, const AncestorSetFeeFracs<S>& anc_feefracs, const S& done, const S& after, uint64_t seed)
{
    ...
    static constexpr unsigned SORT_COST[] = {0,
        0, 2, 4, 6, 9, 13, 17, 21, 26, 32, 38, 44, 51, 59, 67, 75,
        83, 90, 97, 103, 110, 117, 124, 131, 138, 145, 153, 160, 168, 175, 183, 190,
        198, 206, 213, 221, 229, 237, 245, 253, 261, 269, 277, 286, 294, 302, 310, 319,
        327, 335, 344, 352, 360, 369, 378, 386, 395, 404, 413, 421, 430, 439, 447, 456,
        465, 474, 483, 492, 501, 510, 519, 528, 537, 546, 555, 564, 573, 583, 592, 601,
    };
